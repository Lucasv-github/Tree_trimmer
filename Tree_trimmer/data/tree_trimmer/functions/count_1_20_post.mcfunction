...
function tree_trimmer:count_iteration_1_20_post
...
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] mangrove_l = Temp mangrove_l
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] cherry_l = Temp cherry_l
...
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] mangrove_ls = Temp mangrove_ls
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] cherry_ls = Temp cherry_ls
...
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] mangrove_w = Temp mangrove_w
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] cherry_w = Temp cherry_w
...
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] mangrove_ws = Temp mangrove_ws
scoreboard players operation @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=tree_root] cherry_ws = Temp cherry_ws
