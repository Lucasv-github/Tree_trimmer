...
execute at @s[nbt={Item:{id:"minecraft:stripped_spruce_wood"}}] run setblock ~ ~ ~ minecraft:stripped_spruce_wood
execute at @s[nbt={Item:{id:"minecraft:stripped_birch_wood"}}] run setblock ~ ~ ~ minecraft:stripped_birch_wood
execute at @s[nbt={Item:{id:"minecraft:stripped_jungle_wood"}}] run setblock ~ ~ ~ minecraft:stripped_jungle_wood
execute at @s[nbt={Item:{id:"minecraft:stripped_acacia_wood"}}] run setblock ~ ~ ~ minecraft:stripped_acacia_wood
