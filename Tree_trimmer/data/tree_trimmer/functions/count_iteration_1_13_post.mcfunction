...
execute positioned ~1 ~ ~ unless entity @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=tree_blocked,distance=..0.5] if block ~ ~ ~ #logs run function tree_trimmer:count_iteration_1_13_post
execute positioned ~-1 ~ ~ unless entity @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=tree_blocked,distance=..0.5] if block ~ ~ ~ #logs run function tree_trimmer:count_iteration_1_13_post
execute positioned ~ ~1 ~ unless entity @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=tree_blocked,distance=..0.5] if block ~ ~ ~ #logs run function tree_trimmer:count_iteration_1_13_post
execute positioned ~ ~-1 ~ unless entity @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=tree_blocked,distance=..0.5] if block ~ ~ ~ #logs run function tree_trimmer:count_iteration_1_13_post
execute positioned ~ ~ ~1 unless entity @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=tree_blocked,distance=..0.5] if block ~ ~ ~ #logs run function tree_trimmer:count_iteration_1_13_post
