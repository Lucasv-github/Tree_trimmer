...
execute if block ~ ~ ~ minecraft:pale_oak_log run scoreboard players add Temp pale_oak_l 1
...
execute if block ~ ~ ~ minecraft:stripped_pale_oak_log run scoreboard players add Temp pale_oak_ls 1
...
execute if block ~ ~ ~ minecraft:pale_oak_wood run scoreboard players add Temp pale_oak_w 1

execute if block ~ ~ ~ minecraft:stripped_oak_wood run scoreboard players add Temp oak_ls 1
execute if block ~ ~ ~ minecraft:stripped_spruce_wood run scoreboard players add Temp spruce_ls 1
execute if block ~ ~ ~ minecraft:stripped_birch_wood run scoreboard players add Temp birch_ls 1
execute if block ~ ~ ~ minecraft:stripped_jungle_wood run scoreboard players add Temp jungle_ls 1
execute if block ~ ~ ~ minecraft:stripped_acacia_wood run scoreboard players add Temp acacia_ls 1
execute if block ~ ~ ~ minecraft:stripped_dark_oak_wood run scoreboard players add Temp dark_oak_ls 1
execute if block ~ ~ ~ minecraft:stripped_mangrove_wood run scoreboard players add Temp mangrove_ls 1
execute if block ~ ~ ~ minecraft:stripped_cherry_wood run scoreboard players add Temp cherry_ls 1
execute if block ~ ~ ~ minecraft:stripped_pale_oak_wood run scoreboard players add Temp pale_oak_ls 1
