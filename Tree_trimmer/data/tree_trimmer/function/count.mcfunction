...
execute unless entity @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=tree_root,distance=..1] run summon minecraft:armor_stand ~ ~ ~ {Tags:["tree_root"],NoGravity:1b,Marker:1b,Invisible:0b,Silent:1b}
